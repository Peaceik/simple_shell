/**
 * @file _builtin_helpers_b.c
 * @author Peace IGWUDU KINIKA
 *         Bolton DERICK WILHMES
...
/**
 * help_all - Displays all possible builtin builtin commands.
 */
void help_all(void)
{
...
/**
 * help_alias - Displays information on the builtin builtin command 'alias'.
 */
...
/**
 * help_cd - Displays information on the builtin builtin command 'cd'.
 */
void help_cd(void)
{
...
/**
 * help_exit - Displays information on the builtin builtin command 'exit'.
 */
void help_exit(void)
{
